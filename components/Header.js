    ...
    <StyledHeader>
      <Center>
        <Wrapper>
          <Logo href={'/'}>
            <NikeIcon>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 192.756 192.756" id="nike">
          ...
          <StyledNav mobileNavActive={mobileNavActive}>
            ...
            <Dropdown />
            <NavLink href={"/cart"}>Cart ({cartProducts.reduce((total, product) => total + product.quantity, 0)})</NavLink>
          </StyledNav>
