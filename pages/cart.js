                                                ...
                                                return productSizes.map((item, index) => (
                                                    <tr key={`${product._id}- ${index}`}>
                                                        <ProductInfoCell>
                                                            ...
                                                            <StyledStrong>Gender: </StyledStrong>
                                                            <StyledStrong>{product.properties.Gender}</StyledStrong>
                                                            <br />
                                                            <StyledStrong>Size: </StyledStrong>
                                                            <StyledStrong>{item.size}</StyledStrong>
                                                            <br />
                                                            <StyledStrong>Color: </StyledStrong>
                                                            <StyledStrong>{product.properties.Color}</StyledStrong>
                                                        </ProductInfoCell>
                                                        <td>
                                                            <Button
                                                                onClick={() =>
